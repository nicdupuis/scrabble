...
class Joueur:
    ...
    Attributes:
        ...
        chevalet (list): Représente le chevalet (l'ensemble des jetons du joueur).
    """
    ...
    def __init__(self, nom):
        ...
        Raises:
            NomVideException: Si le nom est vide.
        """
        # On valide les pré-conditions
        if not (nom.strip() != ''):
            raise NomVideException('Le nom doit être non vide.')
